    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_clustertooldeposition', 'Can add cluster tool depositions'), ('edit_permissions_for_clustertooldeposition', 'Can edit perms for cluster tool I depositions'), ('view_every_clustertooldeposition', 'Can view all cluster tool depositions'), ('edit_every_clustertooldeposition', 'Can edit all cluster tool depositions')),
            },
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_fivechamberdeposition', 'Can add 5-chamber depositions'), ('edit_permissions_for_fivechamberdeposition', 'Can edit perms for 5-chamber depositions'), ('view_every_fivechamberdeposition', 'Can view all 5-chamber depositions'), ('edit_every_fivechamberdeposition', 'Can edit all 5-chamber depositions')),
            },
            bases=('samples.deposition',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_pdsmeasurement', 'Can add PDS measurements'), ('edit_permissions_for_pdsmeasurement', 'Can edit perms for PDS measurements'), ('view_every_pdsmeasurement', 'Can view all PDS measurements')),
            },
            bases=('samples.process',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_solarsimulatormeasurement', 'Can add solarsimulator measurements'), ('edit_permissions_for_solarsimulatormeasurement', 'Can edit perms for solarsimulator measurements'), ('view_every_solarsimulatormeasurement', 'Can view all solarsimulator measurements')),
            },
            bases=('samples.process',),
        ),
        migrations.CreateModel(
