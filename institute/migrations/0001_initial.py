    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_clustertooldeposition', 'Can add cluster tool depositions'), ('edit_permissions_for_clustertooldeposition', 'Can edit perms for cluster tool I depositions'), ('view_every_clustertooldeposition', 'Can view all cluster tool depositions'), ('change_clustertooldeposition', 'Can edit all cluster tool depositions')),
            },
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('add_fivechamberdeposition', 'Can add 5-chamber depositions'), ('edit_permissions_for_fivechamberdeposition', 'Can edit perms for 5-chamber depositions'), ('view_every_fivechamberdeposition', 'Can view all 5-chamber depositions'), ('change_fivechamberdeposition', 'Can edit all 5-chamber depositions')),
            },
            bases=('samples.deposition',),
        ),
        migrations.CreateModel(
