...
the Django application “jb_institute”, which provides institute-specific views
for all JuliaBase apps.  That's the reason why it must have a ``""`` URL
pattern in the root URL module.
...
urlpatterns += patterns("jb_institute.views.samples",
