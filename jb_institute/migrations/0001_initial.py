...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('clustertoollayer_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='jb_institute.ClusterToolLayer')),
            ...
            bases=('jb_institute.clustertoollayer', models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deposition', models.ForeignKey(related_name='layers', verbose_name='deposition', to='jb_institute.FiveChamberDeposition')),
            ],
            options={
                'ordering': ['number'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_datafile', models.CharField(help_text='only the relative path below "pds/"', max_length=200, verbose_name='raw data file')),
        ...
        migrations.AddField(
            model_name='informallayer',
            name='sample_details',
            field=models.ForeignKey(related_name='informal_layers', verbose_name='sample details', to='jb_institute.SampleDetails'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='informallayer',
        ...
        migrations.AddField(
            model_name='clustertoollayer',
            name='deposition',
            field=models.ForeignKey(related_name='layers', verbose_name='deposition', to='jb_institute.ClusterToolDeposition'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='clustertoollayer',
