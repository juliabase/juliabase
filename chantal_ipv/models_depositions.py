...
class SixChamberDeposition(samples.models_depositions.Deposition):
    ...
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.six_chamber_deposition.show", [urlquote(self.number, safe="")])
...
class LargeAreaDeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.large_area_deposition.show", [urlquote(self.number, safe="")])
...
class OldClusterToolDeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.old_cluster_tool_deposition.show", [urlquote(self.number, safe="")])
...
class NewClusterToolDeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.new_cluster_tool_deposition.show", [urlquote(self.number, safe="")])
...
class PHotWireDeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.p_hot_wire_deposition.show", [urlquote(self.number, safe="")])
...
class FiveChamberDeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.five_chamber_deposition.show", [urlquote(self.number, safe="")])
...
class LargeSputterDeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.large_sputter_deposition.show", [urlquote(self.number, safe="")])
...
class LADADeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.lada_deposition.show", [urlquote(self.number, safe="")])
...
class JANADeposition(samples.models_depositions.Deposition):
    ...
    @models.permalink
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.jana_deposition.show", [urlquote(self.number, safe="")])
