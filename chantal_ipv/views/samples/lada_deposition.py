...
from chantal_ipv import settings
from chantal_ipv.mfc_calibrations import get_calibrations_from_datafile
...
def calculate_silane_concentration(layer):
    ...
    :type layer: ``chantal_ipv.models_depositions.LADALayer``
