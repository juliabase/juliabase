...
def edit(request, process_number):
    """Edit or create a small evaporation plant process.  In case of creation, starting
    ...
    if request.method == "POST":
        ...
        if process:
            ...
            if process_number:
                ...
                for sample in form_set.samples_form.cleaned_data["sample_list"]:
    ...
    return render_to_response("samples/edit_small_evaporation.html", context_dict,
