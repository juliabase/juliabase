...
from chantal_ipv import layouts
import chantal_ipv.views.shared_utils as ipv_utils
from chantal_ipv.models_depositions import five_chamber_chamber_choices, five_chamber_hf_frequency_choices
...
class PDSMeasurement(PhysicalProcess):
    ...
    def get_absolute_url(self):
        return ("chantal_ipv.views.samples.pds_measurement.show", (), {"pds_number": urlquote(self.number, safe="")})
...
class SolarsimulatorPhotoMeasurement(PhysicalProcess):
    ...
    def get_context_for_user(self, user, old_context):
        ...
        context["thumbnail_layout"] = django.core.urlresolvers.reverse(
            "chantal_ipv.views.samples.layout.show_layout", kwargs={"sample_id": sample.id, "process_id": self.id})
