...
#
# Copyright (C) 2012 Forschungszentrum Jülich, Germany,
...
import chantal_ipv.reportlab_config
...
def print_line(canvas, y, fontsize, line, force=False):
    ...
    textobject.setFont(chantal_ipv.reportlab_config.default_fontname, fontsize)
    width = canvas.stringWidth(line, chantal_ipv.reportlab_config.default_fontname, fontsize)
