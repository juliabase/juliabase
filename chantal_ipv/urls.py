...
the Django application “chantal_ipv”, which provides IEF-5-specific views for
...
urlpatterns = patterns("chantal_ipv.views.statistics",
                       (r"^about$", "about"),
                       (r"^statistics$", "statistics"),
                       )

urlpatterns += patterns("chantal_ipv.views",
...
urlpatterns += patterns("chantal_ipv.views.samples",
