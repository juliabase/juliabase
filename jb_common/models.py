...
class UserDetails(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name=_("department"), related_name="user_details",
...
class Topic(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name=_("department"), related_name="topic")
    parent_topic = models.ForeignKey("self", on_delete=models.CASCADE, verbose_name=_("parent topic"), related_name="child_topics",
                                    blank=True, null=True)
    manager = models.ForeignKey(django.contrib.auth.models.User, on_delete=models.CASCADE, verbose_name=_("topic manager"),
...
class ErrorPage(models.Model):
    ...
    user = models.ForeignKey(django.contrib.auth.models.User, on_delete=models.CASCADE, null=True, blank=True, verbose_name=_("user"),
