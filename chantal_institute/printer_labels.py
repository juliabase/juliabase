...
def print_line(canvas, y, fontsize, line, force=False):
    ...
    textobject.setFont(chantal_institute.reportlab_config.default_fontname, fontsize)
    width = canvas.stringWidth(line, chantal_institute.reportlab_config.default_fontname, fontsize)
