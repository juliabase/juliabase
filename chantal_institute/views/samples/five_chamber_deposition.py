...
class DepositionForm(form_utils.ProcessForm):
    ...
    class Meta:
        model = ipv_models.FiveChamberDeposition
...
class LayerForm(forms.ModelForm):
    ...
    class Meta:
        model = ipv_models.FiveChamberLayer
        exclude = ("deposition",)
...
class FormSet(object):
    ...
    :type deposition: `ipv_models.FiveChamberDeposition` or ``NoneType``
    """
    ...
    def __init__(self, request, deposition_number):
        ...
        self.deposition = \
            get_object_or_404(ipv_models.FiveChamberDeposition, number=deposition_number) if deposition_number else None
    ...
    def from_post_data(self, post_data):
        ...
        self.add_layers_form = form_utils.AddLayersForm(self.user_details, ipv_models.FiveChamberDeposition, self.post_data)
    ...
    def from_database(self, query_dict):
        ...
        def __read_layer_forms(source_deposition):
            ...
            :type source_deposition: `ipv_models.FiveChamberDeposition`
        ...
        if not self.deposition and copy_from:
            ...
            source_deposition_query = ipv_models.FiveChamberDeposition.objects.filter(number=copy_from)
    ...
    def save_to_database(self):
        ...
        :rtype: `ipv_models.FiveChamberDeposition` or ``NoneType``
        """
...
def edit(request, deposition_number):
    ...
    return form_utils.edit_depositions(request,
                                       ...
                                       ipv_models.FiveChamberDeposition,
