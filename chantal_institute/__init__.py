...
from chantal_institute import auth
            ...
            for process in sample.processes.all():
                ...
                if hasattr(process, "update_informal_layers"):
                    ...
                    process.update_informal_layers(
                        ...
                        lambda ** kwargs: chantal_institute_app.InformalLayer(sample_details=sample.sample_details,
...
def clear_structuring_processes(sender, **kwargs):
    ...
    for sample in Sample.objects.iterator():
        structurings = chantal_institute_app.Structuring.objects.filter(samples=sample).order_by("timestamp")
