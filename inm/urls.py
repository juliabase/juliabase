...
urlpatterns += patterns("inm.views.samples",
                        ...
                        url(r"^solarsimulator_measurements/add/$", "solarsimulator_measurement.edit",
                            {"solarsimulator_measurement_id": None}, "add_solarsimulator_measurement"),
                        url(r"^solarsimulator_measurements/(?P<solarsimulator_measurement_id>\d+)/edit/$",
                            "solarsimulator_measurement.edit", name="edit_solarsimulator_measurement"),
                        url(r"solarsimulator_measurements/(?P<solarsimulator_measurement_id>\d+)$",
                            "solarsimulator_measurement.show", name="show_solarsimulator_measurement"),

                        url(r"^structuring_process/add/$", "structuring.edit", {"solarsimulator_measurement_id": None},
                            "add_sructuring"),
