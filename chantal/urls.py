...
urlpatterns = patterns("",
                       ...
                       (r"^6-chamber_depositions/edit/(?P<deposition_number>.+)",
                       ...
                       (r"^splits/(?P<parent_name>.+)", "samples.views.split_and_rename.split_and_rename"),
                       ...
                       (r"^comments/edit/(?P<process_id>.+)$", "samples.views.comment.edit"),
