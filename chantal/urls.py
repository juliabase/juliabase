...
urlpatterns = patterns("",
                       ...
                       (r"^6-chamber_depositions/add/$", "samples.views.six_chamber_deposition.edit",
                       ...
                       (r"^large-area_depositions/add/$", "samples.views.large_area_deposition.edit",
                        {"deposition_number": None}, "add_large-area_deposition"),
                       url(r"^large-area_depositions/lab_notebook/(?P<year_and_month>.*)/export/",
                           "samples.views.lab_notebook.export", {"process_name": "LargeAreaDeposition"},
                       ...
                       (r"^large-area_depositions/lab_notebook/(?P<year_and_month>.*)",
                        ...
                        "lab_notebook_LargeAreaDeposition"),
                       ...
                       (r"^large-area_depositions/(?P<deposition_number>.+)", "samples.views.large_area_deposition.show"),
                       
                       (r"^small_cluster_tool_depositions/add/$", "samples.views.small_cluster_tool_deposition.edit",
                       ...
                       (r"^results/add/$", "samples.views.result.edit", {"process_id": None}, "add_result"),
                       url(r"^results/(?P<process_id>.+)/edit/$", "samples.views.result.edit", name="edit_result"),
                       (r"^results/(?P<process_id>.+)/export/$", "samples.views.result.export"),
                       (r"^results/(?P<process_id>.+)", "samples.views.result.show"),

                       (r"^pds_measurements/add/$", "samples.views.pds_measurement.edit", {"pds_number": None},
                        "add_pds_measurement"),
