...
#                       (r"^samples/add/$", "sample.add"),
                       ...
                       (r"^samples/rename/$", "sample.rename_sample"),
                       ...
                       (r"^fold_process/(?P<sample_id>\d+)$", "json_client.fold_process"),
                       (r"^folded_processes/(?P<sample_id>\d+)$", "json_client.get_folded_processes"),
