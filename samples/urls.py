...
#                       (r"^samples/add/$", "sample.add"),
                       ...
                       (r"^results/images/(?P<process_id>.+)", "result.show_image"),
                       (r"^results/thumbnails/(?P<process_id>.+)", "result.show_thumbnail"),
                       (r"^results/(?P<process_id>.+)", "result.show"),

                       url(r"^plots/thumbnails/(?P<process_id>.+)/(?P<number>[0-9]+)", "plots.show_plot",
                           {"thumbnail": True}, "process_plot_thumbnail"),
                       url(r"^plots/thumbnails/(?P<process_id>.+)", "plots.show_plot", {"number": 0, "thumbnail": True},
                           "default_process_plot_thumbnail"),
                       url(r"^plots/(?P<process_id>.+)/(?P<number>[0-9]+)", "plots.show_plot", {"thumbnail": False},
                           "process_plot"),
                       url(r"^plots/(?P<process_id>.+)", "plots.show_plot", {"number": 0, "thumbnail": False},
